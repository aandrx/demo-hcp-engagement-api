  ...
  const handleSearch = async (query?: string) => {
    ...
    try {
      ...
      if (literatureResponse.ok) {
        ...
        console.log('📚 Studies data:', literatureData.data?.studies);
        console.log('📚 Studies length:', literatureData.data?.studies?.length);
        setSearchResults(literatureData.data?.studies || []);
        console.log('📚 Search results set:', literatureData.data?.studies?.length || 0, 'results');
      } else {
